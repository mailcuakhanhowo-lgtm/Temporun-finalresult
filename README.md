...
- **Giới hạn của Phương án Tách Trạm Tính Điểm (Temporal Soft Fusion V.2)**: Đội thi ứng dụng thuật toán Cửa sổ Trượt (Sliding Window) để phân tích các biến cố thời gian (Cảnh trước/Cảnh sau). Tuy nhiên, thực tế nghiệm thu cho thấy phương pháp này **không tạo ra sự đột phá về điểm số tổng thể**. Nguyên nhân là do phần lớn các câu truy vấn trong tập dữ liệu đều mang tính chất tĩnh (chỉ cần tập trung vào Cảnh chính là đủ), khiến tiềm năng của thuật toán chuỗi thời gian chưa được phát huy tối đa. Dù vậy, đội thi vẫn quyết định giữ lại kiến trúc này làm mỏ neo cốt lõi nhằm đảm bảo hệ thống có đủ sức mạnh để "bắt" được các câu hỏi phức tạp nhất.
