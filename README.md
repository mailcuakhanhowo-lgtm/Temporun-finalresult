...
- **Giới hạn của Phương án Tách Trạm Tính Điểm (Early Weighted Fusion)**: Đội thi đã thử nghiệm việc bóc tách câu truy vấn thành các đặc trưng nguyên tử (Chủ thể, Hành động, Bối cảnh) và chấm điểm vector cho từng "Trạm" riêng biệt, sau đó cộng gộp trọng số (Fusion). Mục tiêu ban đầu là giúp hệ thống không bỏ sót chi tiết nhỏ. Tuy nhiên, thực tế nghiệm thu cho thấy phương án này **không thể nâng cao điểm số tổng thể**. Nguyên nhân cốt lõi là do việc "chẻ nhỏ" câu văn làm đứt gãy sự liên kết ngữ nghĩa liền mạch (Holistic Context), khiến Vector bị nhiễu loạn và pha loãng. Hiện tại, kiến trúc dùng một Câu Đảo Ngữ Toàn Cảnh (Original Rephrase) làm mỏ neo vẫn là phương án mang lại độ chính xác (Precision) cao nhất.
